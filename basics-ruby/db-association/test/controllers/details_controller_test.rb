...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { address: @detail.address, dob: @detail.dob, father_name: @detail.father_name, mother_name: @detail.mother_name, phone: @detail.phone }
    end
  ...
  test "should update detail" do
    patch :update, id: @detail, detail: { address: @detail.address, dob: @detail.dob, father_name: @detail.father_name, mother_name: @detail.mother_name, phone: @detail.phone }
    assert_redirected_to detail_path(assigns(:detail))
  end
